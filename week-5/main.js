...
function accessCode(e) {
	...
	if (userAccess === 1234) {
		...
		para1.innerHTML =
			'Each node in the DOM tree is an object with methods and properties. Every the document, elements, pieces of text and even whitespace in the HTML is represented by it’s own DOM node. For this challenge, navigate to <a href="https://github.com/JessicaGilfillan/AllAboutTheDOM/tree/master/active-learning/02-node-or-not-a-node"> https://github.com/JessicaGilfillan/AllAboutTheDOM/tree/master/active-learning/02-node-or-not-a-node </a> and download the code provided. Identify each node with a comment and then include a number at the bottom detailing the total amount of nodes on the page (comments not included.) <strong>This is Part Two of Lab 4.</strong> ';
		para2.innerHTML =
		...
		para1.innerHTML =
			'Once we can access the right element, we can start to manipulate or change the properties of these elements. We can also add and remove DOM nodes and get and set attributes on our elements. navigate to <a href="https://github.com/JessicaGilfillan/AllAboutTheDOM/tree/master/active-learning/05-master-of-dom-manipulation">https://github.com/JessicaGilfillan/AllAboutTheDOM/tree/master/active-learning/05-master-of-dom-manipulation</a> and download the code files. Your instructions are in main.js. <strong> This is Part 5 of Lab 4. All done!!!! Zip all files (include your image file from activity one) and submit for Lab 4! </strong>';
		para2.innerHTML = "";
		iframe.style.display = "block";
		iframe.style.margin = "0 auto";
		iframe.src =
